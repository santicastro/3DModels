	...
	involute_facets=0)
{
	...
	pitch_diameter  = 3*number_of_teeth * circular_pitch / 180;
	...
	pitch_diametrial = 3*number_of_teeth / pitch_diameter;

	// Addendum: Radial distance from pitch circle to outside circle.
	addendum = 1.5*1/pitch_diametrial;
...
function gear_diameter(
	number_of_teeth,
	circular_pitch, diametral_pitch) = 

	3*number_of_teeth * (circular_pitch!=false?circular_pitch:180/diametral_pitch) / 180
;
